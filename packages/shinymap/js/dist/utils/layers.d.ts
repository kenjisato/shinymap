 ...
 */
export declare function assignLayers(regions: Record<RegionId, Element[]>, underlays?: string[], overlays?: string[], hidden?: string[], metadata?: OutlineMetadata): LayerAssignment;
/**
